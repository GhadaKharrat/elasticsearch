...
public class BookServiceTest {
    ...
    public BookServiceTest(BookService bookService, ElasticsearchTemplate elasticsearchTemplate) {
    ...
    public void testFindByAuthor() {
        ...
        assertThat(byAuthor.getTotalElements()).isEqualTo(4L);

        Page<Book> byAuthor2 = bookService.findByAuthor("Mkyong", new PageRequest(0, 10));
        assertThat(byAuthor2.getTotalElements()).isEqualTo(1L);
